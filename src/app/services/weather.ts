...
export type WeatherTheme = 'default' | 'sunny' | 'partly-cloudy' | 'cloudy' | 'cloudy-night' | 'rainy' | 'snowy' | 'stormy' | 'foggy' | 'sunset' | 'night';
...
export class WeatherService {
  ...
  private getWeatherTheme(
    ...
    if (!isDaylight) return [1, 2, 3].includes(code) || cloudCover > 30 ? 'cloudy-night' : 'night';
    if (this.isNearSunset(localIso, sunset) || this.isNearSunrise(localIso, sunrise)) return 'sunset';
